...
class ContactURLTests(TestCase):
    ...
    def test_post_edit_page_context(self):
        ...
        post_id = str(self.post.id)
        response = self.user_author.get(reverse('posts:post_edit', kwargs={'post_id': post_id}))
        form_fields = {
            'text': forms.fields.CharField,
            'group': forms.ModelChoiceField,
        }
    ...
    def test_group_list_page(self):
        ...
        response = self.guest.get(reverse('posts:group_list', kwargs={'slug': 'test-slug'}))
        first_object = response.context['page_obj'][0]
        post_group_0 = first_object.group
        post_text_0 = first_object.text
        post_author_0 = first_object.author
    ...
    def test_profile_page(self):
        ...
        response = self.guest.get(reverse('posts:profile', kwargs={'username':'test'}))
        first_object = response.context['page_obj'][0]
        post_group_0 = first_object.group
        post_text_0 = first_object.text
        post_author_0 = first_object.author
    ...
    def test_post_detail_page(self):
        ...
        post_id = str(self.post.id)
        response = self.guest.get(reverse('posts:post_detail', kwargs={'post_id': post_id}))
